...
public class TabUtils {
    ...
    public static void installCopyPasteHandler(TableView<Employee> table) {
        ...
        public void handle(final KeyEvent keyEvent) {
            ...
            if (copyKeyCodeCompination.match(keyEvent)) {
                ...
                if( keyEvent.getSource() instanceof TableView) {
                    ...
                    // copy to clipboard
                    copySelectionToClipboard( (TableView<Employee>) keyEvent.getSource());
                ...
                if( keyEvent.getSource() instanceof TableView) {
                    ...
                    // copy to clipboard
                    pasteClipboard( (TableView<Employee>) keyEvent.getSource());
     ...
     * @param table
     */
    public static void copySelectionToClipboard(TableView<Employee> table) {
    ...
    public static void pasteClipboard(TableView<Employee> table) {
        ...
        pasteString = Clipboard.getSystemClipboard().getString();
